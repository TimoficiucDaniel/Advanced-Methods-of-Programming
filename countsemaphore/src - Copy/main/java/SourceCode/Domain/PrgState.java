...
public class PrgState {
    ...
    private static Integer LastThreadId=1;

    ISem<Integer, Pair<Integer, List<Integer>>> semTable;
    ...
    public PrgState(MyIDictionary<String, Value> symTbl, MyIStack<IStmt> execution, MyIList<Value> out, IStmt originalProgram
                    , MyIDictionary<StringValue,BufferedReader> fileTable, IHeap<Integer,Value> heap, Integer id, ISem<Integer, Pair<Integer, List<Integer>>> semTable) {
        this.symTbl = symTbl;
    ...
    public ISem<Integer, Pair<Integer, List<Integer>>> getSemTable() {
        return semTable;
    }
