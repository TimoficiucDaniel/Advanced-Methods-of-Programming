...
public class PrgState {
    ...
    private IBarrier<Integer, Pair<Integer, List<Integer>>> barrier;
    ...
    public PrgState(MyIDictionary<String, Value> symTbl, MyIStack<IStmt> execution, MyIList<Value> out, IStmt originalProgram
                    , MyIDictionary<StringValue,BufferedReader> fileTable, IHeap<Integer,Value> heap, Integer id, IBarrier<Integer, Pair<Integer, List<Integer>>> barrier) {
        this.symTbl = symTbl;
