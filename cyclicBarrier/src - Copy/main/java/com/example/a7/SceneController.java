...
public class SceneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        IStmt ex12 = new CompStmt(new VarDecStmt("a", new IntType()),
                new CompStmt(new VarDecStmt("b", new IntType()),
                        new CompStmt(new VarDecStmt("c", new IntType()),
                                        ...
                                        new CompStmt(new AssignStmt("b", new ValueExp(new IntValue(2))),
                                                new CompStmt(new AssignStmt("c", new ValueExp(new IntValue(5))),
                                                        new CompStmt(new SwitchStatement(
                                                                new ArithmeticExp('*', new VariableExp("a"), new ValueExp(new IntValue(10))),
