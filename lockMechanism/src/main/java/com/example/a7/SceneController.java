...
public class SceneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        IStmt ex12 = new CompStmt(new VarDecStmt("v",new IntType()),new CompStmt(new AssignStmt("v",new ValueExp(new IntValue(20))),
                new CompStmt(new ForStmt(new ValueExp(new IntValue(0)),new ValueExp(new IntValue(3)),new ArithmeticExp('+',
                        new VariableExp("v"),new ValueExp(new IntValue(1))),"v",new forkStmt(new CompStmt(new PrintStmt(new VariableExp("v")),
                        new AssignStmt("v",new ArithmeticExp('+',new VariableExp("v"),new ValueExp(new IntValue(1))))))),new PrintStmt(
                                new ArithmeticExp('*',new VariableExp("v"),new ValueExp(new IntValue(10)))))));
