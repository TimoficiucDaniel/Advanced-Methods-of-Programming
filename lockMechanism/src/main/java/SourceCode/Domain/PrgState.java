...
public class PrgState {
    ...
    public PrgState(MyIDictionary<String, Value> symTbl, MyIStack<IStmt> execution, MyIList<Value> out, IStmt originalProgram
                    , MyIDictionary<StringValue,BufferedReader> fileTable, IHeap<Integer,Value> heap,Integer id,ILock<Integer,Integer> locktable) {
        this.symTbl = symTbl;
